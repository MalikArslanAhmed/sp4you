                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.expenses.update", [$expense->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="date" id="date" value="{{ old('date', $expense->date) }}" required>
                            @if($errors->has('date'))
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="decscription" id="decscription" value="{{ old('decscription', $expense->decscription) }}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="needsclick dropzone" id="receipt_photo-dropzone">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="ammount" id="ammount" value="{{ old('ammount', $expense->ammount) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="invoice_number_id" id="invoice_number_id">
                                @foreach($invoice_numbers as $id => $entry)
                                    <option value="{{ $id }}" {{ (old('invoice_number_id') ? old('invoice_number_id') : $expense->invoice_number->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
