        ...
        <div class="col-md-12">
            @can('leave_application_create')
                <div style="margin-bottom: 10px;" class="row">
                    <div class="col-lg-12">
                        <a class="btn btn-success" href="{{ route('frontend.leave-applications.create') }}">
                                    ...
                                    <tr data-entry-id="{{ $leaveApplication->id }}">
                                        ...
                                        <td>
                                            @can('leave_application_show')
                                                <a class="btn btn-xs btn-primary" href="{{ route('frontend.leave-applications.show', $leaveApplication->id) }}">
                                                    {{ trans('global.view') }}
                                                </a>
                                            @endcan
...
@can('leave_application_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('frontend.leave-applications.massDestroy') }}",
