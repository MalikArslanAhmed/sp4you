...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.staff-availabilities.update", [$staffAvailability->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('monday') ? 'is-invalid' : '' }}" type="text" name="monday" id="monday" value="{{ old('monday', $staffAvailability->monday) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('tuesday') ? 'is-invalid' : '' }}" type="text" name="tuesday" id="tuesday" value="{{ old('tuesday', $staffAvailability->tuesday) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('wednesday') ? 'is-invalid' : '' }}" type="text" name="wednesday" id="wednesday" value="{{ old('wednesday', $staffAvailability->wednesday) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('thursday') ? 'is-invalid' : '' }}" type="text" name="thursday" id="thursday" value="{{ old('thursday', $staffAvailability->thursday) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('friday') ? 'is-invalid' : '' }}" type="text" name="friday" id="friday" value="{{ old('friday', $staffAvailability->friday) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('saturday') ? 'is-invalid' : '' }}" type="text" name="saturday" id="saturday" value="{{ old('saturday', $staffAvailability->saturday) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('sunday') ? 'is-invalid' : '' }}" type="text" name="sunday" id="sunday" value="{{ old('sunday', $staffAvailability->sunday) }}">
