                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    ...
                                    @can('leave_application_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.leave-applications.index') }}">
                                    ...
                                    @can('staff_availability_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.staff-availabilities.index') }}">
                                    ...
                                    @can('client_tag_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.client-tags.index') }}">
