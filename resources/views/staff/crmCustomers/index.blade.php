...
@can('crm_customer_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('staff.crm-customers.create') }}">
                        ...
                        <tr data-entry-id="{{ $crmCustomer->id }}">
                            ...
                            <td>
                                @can('crm_customer_show')
                                    <a class="btn btn-xs btn-primary" href="{{ route('staff.crm-customers.show', $crmCustomer->id) }}">
                                        {{ trans('global.view') }}
                                    </a>
                                @endcan

                                @can('crm_customer_edit')
                                    <a class="btn btn-xs btn-info" href="{{ route('staff.crm-customers.edit', $crmCustomer->id) }}">
                                        {{ trans('global.edit') }}
                                    </a>
                                @endcan

                                @can('crm_customer_delete')
                                    <form action="{{ route('staff.crm-customers.destroy', $crmCustomer->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
...
@can('crm_customer_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('staff.crm-customers.massDestroy') }}",
