...
<div class="card">
    ...
    <div class="card-body">
        <div class="form-group">
            <div class="form-group">
                <a class="btn btn-default" href="{{ route('staff.crm-customers.index') }}">
...
<div class="card">
    ...
    <div class="tab-content">
        <div class="tab-pane" role="tabpanel" id="customer_crm_notes">
            @includeIf('staff.crmCustomers.relationships.customerCrmNotes', ['crmNotes' => $crmCustomer->customerCrmNotes])
        </div>
        <div class="tab-pane" role="tabpanel" id="customer_crm_documents">
            @includeIf('staff.crmCustomers.relationships.customerCrmDocuments', ['crmDocuments' => $crmCustomer->customerCrmDocuments])
        </div>
        <div class="tab-pane" role="tabpanel" id="client_photos">
            @includeIf('staff.crmCustomers.relationships.clientPhotos', ['photos' => $crmCustomer->clientPhotos])
        </div>
        <div class="tab-pane" role="tabpanel" id="client_expenses">
            @includeIf('staff.crmCustomers.relationships.clientExpenses', ['expensesDetails' => $crmCustomer->clientExpensesDetails])
        </div>
        <div class="tab-pane" role="tabpanel" id="clients_appointments">
            @includeIf('staff.crmCustomers.relationships.clientsAppointments', ['appointments' => $crmCustomer->clientsAppointments])
        </div>
        <div class="tab-pane" role="tabpanel" id="clients_invoices">
            @includeIf('staff.crmCustomers.relationships.clientsInvoices', ['invoices' => $crmCustomer->clientsInvoices])
        </div>
    </div>
</div>
