...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("staff.crm-customers.update", [$crmCustomer->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('postcode') ? 'is-invalid' : '' }}" type="number" name="postcode" id="postcode" value="{{ old('postcode', $crmCustomer->postcode) }}" step="1">
