...
class AppointmentController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('staff.appointments.create', compact('assigned_staffs', 'clients', 'statuses'));
    }
    ...
    public function edit(Appointment $appointment)
    {
        ...
        return view('staff.appointments.edit', compact('appointment', 'assigned_staffs', 'clients', 'statuses'));
    }
