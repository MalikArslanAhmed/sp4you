...
class BillingRunController extends Controller
{
    public function index()
    {
        ...
        return view('staff.billingRuns.index', compact('invoices'));
    }
    ...
    public function create()
    {
        ...
        return view('staff.billingRuns.create');
    }
    ...
    public function store(StoreBillingRunRequest $request)
    {
        ...
        return redirect()->route('staff.billing-runs.index');
    }
    ...
    public function edit(Invoice $billingRun)
    {
        ...
        return view('staff.billingRuns.edit', compact('billingRun'));
    }
    ...
    public function show($id)
    {
        ...
        return view('staff.billingRuns.show', compact('invoice'));
    }
