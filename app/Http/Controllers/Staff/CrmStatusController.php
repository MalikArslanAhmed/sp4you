...
class CrmStatusController extends Controller
{
    public function index()
    {
        ...
        return view('staff.crmStatuses.index', compact('crmStatuses'));
    }
    ...
    public function create()
    {
        ...
        return view('staff.crmStatuses.create');
    }
    ...
    public function store(StoreCrmStatusRequest $request)
    {
        ...
        return redirect()->route('staff.crm-statuses.index');
    }
    ...
    public function edit(CrmStatus $crmStatus)
    {
        ...
        return view('staff.crmStatuses.edit', compact('crmStatus'));
    }
    ...
    public function show(CrmStatus $crmStatus)
    {
        ...
        return view('staff.crmStatuses.show', compact('crmStatus'));
    }
