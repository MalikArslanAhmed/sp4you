...
class UserAlertsController extends Controller
{
    public function index()
    {
        ...
        return view('staff.userAlerts.index', compact('userAlerts'));
    }
    ...
    public function create()
    {
        ...
        return view('staff.userAlerts.create', compact('users'));
    }
    ...
    public function store(StoreUserAlertRequest $request)
    {
        ...
        return redirect()->route('staff.user-alerts.index');
    }
    ...
    public function show(UserAlert $userAlert)
    {
        ...
        return view('staff.userAlerts.show', compact('userAlert'));
    }
