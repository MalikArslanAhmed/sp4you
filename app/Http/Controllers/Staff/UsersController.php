...
class UsersController extends Controller
{
    ...
    public function edit(User $user)
    {
        ...
        return view('staff.users.edit', compact('roles', 'user'));
    }
    ...
    public function show(User $user)
    {
        ...
        $user->load('roles', 'staffMemberLeaveApplications', 'staffMemberStaffAvailabilities', 'userUserAlerts', 'assignedStaffAppointments');
