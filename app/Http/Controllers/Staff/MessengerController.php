...
class MessengerController extends Controller
{
    public function index()
    {
        ...
        return view('staff.messenger.index', compact('topics', 'title', 'unreads'));
    }
    ...
    public function createTopic()
    {
        ...
        return view('staff.messenger.create', compact('users', 'unreads'));
    }
    ...
    public function storeTopic(QaTopicCreateRequest $request)
    {
        ...
        return redirect()->route('staff.messenger.index');
    }
    ...
    public function showMessages(QaTopic $topic)
    {
        ...
        return view('staff.messenger.show', compact('topic', 'unreads'));
    }
    ...
    public function showReply(QaTopic $topic)
    {
        ...
        return view('staff.messenger.reply', compact('topic', 'unreads'));
    }
