...
class CrmDocumentController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('staff.crmDocuments.index', compact('crmDocuments'));
    }
    ...
    public function create()
    {
        ...
        return view('staff.crmDocuments.create', compact('customers'));
    }
    ...
    public function store(StoreCrmDocumentRequest $request)
    {
        ...
        return redirect()->route('staff.crm-documents.index');
    }
    ...
    public function edit(CrmDocument $crmDocument)
    {
        ...
        return view('staff.crmDocuments.edit', compact('crmDocument', 'customers'));
    }
    ...
    public function show(CrmDocument $crmDocument)
    {
        ...
        return view('staff.crmDocuments.show', compact('crmDocument'));
    }
