...
class AppoimntmentStatusController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.appoimntmentStatuses.index', compact('appoimntmentStatuses'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.appoimntmentStatuses.create');
    }
    ...
    public function store(StoreAppoimntmentStatusRequest $request)
    {
        ...
        return redirect()->route('frontend.appoimntment-statuses.index');
    }
    ...
    public function edit(AppoimntmentStatus $appoimntmentStatus)
    {
        ...
        return view('frontend.appoimntmentStatuses.edit', compact('appoimntmentStatus'));
    }
    ...
    public function show(AppoimntmentStatus $appoimntmentStatus)
    {
        ...
        return view('frontend.appoimntmentStatuses.show', compact('appoimntmentStatus'));
    }
