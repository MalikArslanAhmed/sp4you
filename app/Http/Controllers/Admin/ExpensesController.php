...
class ExpensesController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.expenses.create', compact('appointments', 'clients', 'invoice_numbers'));
    }
    ...
    public function edit(Expense $expense)
    {
        ...
        return view('admin.expenses.edit', compact('appointments', 'clients', 'expense', 'invoice_numbers'));
    }
