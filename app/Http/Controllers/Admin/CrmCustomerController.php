...
class CrmCustomerController extends Controller
{
    public function index()
    {
        ...
        return view('admin.crmCustomers.index', compact('client_tags', 'crmCustomers', 'crm_statuses'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.crmCustomers.create', compact('statuses', 'tags'));
    }
    ...
    public function edit(CrmCustomer $crmCustomer)
    {
        ...
        return view('admin.crmCustomers.edit', compact('crmCustomer', 'statuses', 'tags'));
    }
